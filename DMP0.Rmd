---
author: 'Jamshid Ardalankia, Gail Clement'
date: "`r format(Sys.time(), '%d %B, %Y')`"
output:
  html_document:
    toc: TRUE
    toc_float: TRUE
    number_sectoins: TRUE
    theme: paper
    highlight: tango
    fig_width: 4
    fig_height: 6
...
# Backgroeund {-}
 ...
 ![figure 1. Area Map](img/rio-grande-basin.png){width=20%}
...
```{r plot, echo=TRUE}
plot(faithful, main = "Do I wait longer for longer  ...")
```


## subheading for section1
### subheading
- This project will result in the production of a relational [ see, for example, @Clement_2013].
